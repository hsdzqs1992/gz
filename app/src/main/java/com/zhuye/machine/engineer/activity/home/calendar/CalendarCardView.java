package com.zhuye.machine.engineer.activity.home.calendar;
...
import static com.zhuye.machine.engineer.activity.home.calendar.CalendarCardView.State.NEXT_MONTH_DAY;
import static com.zhuye.machine.engineer.activity.home.calendar.CalendarCardView.State.PAST_MONTH_DAY;
...
public class CalendarCardView extends View {
    ...
    private void init(Context context) {
        ...
        mCirclePaint.setColor(Color.parseColor("#1981d1")); // 红色圆形
...
//                        mTextPaint.setColor(Color.BLACK);
                        canvas.drawBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.sign_0),
